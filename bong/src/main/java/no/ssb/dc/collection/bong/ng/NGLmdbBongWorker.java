...
public class NGLmdbBongWorker implements CsvWorker<NGBongKey> {

    private final LmdbCsvRepository<NGBongKey> csvRepository;

    public NGLmdbBongWorker(SourceLmdbConfiguration sourceConfiguration, TargetConfiguration targetConfiguration) {
